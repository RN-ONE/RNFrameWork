...
export default class RefreshableFlatList extends Component {
    ...
    static defaultProps = {
        ...
        topIndicatorComponent: CustomIndicator,
        bottomIndicatorComponent: CustomIndicator,
        onScroll: () => {
        },
        onRefreshing: () => {
        },
        ...
        topHoldingPrompt: '释放刷新',
        topRefreshingPrompt: '刷新中...',
        bottomPullingPrompt: '上拉加载更多',
        bottomHoldingPrompt: '释放加载更多',
    ...
    onPanResponderRelease = () => {
        ...
        if ((showTopIndicator && scrollStatus === 'EXCEEDED_MIN_PULL_DOWN_DISTANCE')
            ...
            if (scrollStatus.indexOf('UP') > -1) {
                toValue = {
                    x: 0,
                    y: -(this.props.minPullDownDistance + this.props.minPullDownDistance)
                };
